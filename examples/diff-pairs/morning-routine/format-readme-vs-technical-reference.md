---
diff_pair_id: format-readme-vs-technical-reference-morning-routine
...
# Diff Pair: Format swap - `readme` vs `technical-reference`

**Topic:** How to start a morning routine
**Axis varied:** format
**A:** `readme` - The front-door document for a software project - tells a first-time visitor what it is, why it exists, how to use it, and where to go next.
