---
diff_pair_id: format-devotional-entry-vs-technical-reference-morning-routine
topic_slug: morning-routine
topic_label: How to start a morning routine
axis_varied: format
entry_a: devotional-entry
entry_b: technical-reference
generator: tools/diff-pair-generator.py
review_status: reviewed
---

# Diff Pair: Format swap - `devotional-entry` vs `technical-reference`

**Topic:** How to start a morning routine
**Axis varied:** format
**A:** `devotional-entry` - A short, spiritually-oriented piece designed for daily reading - typically anchored to a scripture passage and closing with reflection or prayer.
**B:** `technical-reference` - A stable lookup document designed for repeated return visits. Optimized for scanning over reading. The reader arrives with a specific question; the format serves that question.
