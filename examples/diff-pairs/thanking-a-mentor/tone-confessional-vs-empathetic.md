---
diff_pair_id: tone-confessional-vs-empathetic-thanking-a-mentor
topic_slug: thanking-a-mentor
topic_label: Writing to thank a mentor who shaped your career
axis_varied: tone
entry_a: confessional
entry_b: empathetic
generator: tools/diff-pair-generator.py
review_status: reviewed
---

# Diff Pair: Tone swap - `confessional` vs `empathetic`

**Topic:** Writing to thank a mentor who shaped your career
**Axis varied:** tone
**A:** `confessional` - The writer admits something about themselves - a specific failure, doubt, or learning, owned without performance.
**B:** `empathetic` - Acknowledges the reader's specific experience before asking anything of them - earns the right to continue by naming the difficulty accurately.
