---
diff_pair_id: tone-candid-vs-confident-async-standups
...
# Diff Pair: Tone swap - `candid` vs `confident`
...
**B:** `confident` - The affect of someone who has thought about this and is ready to say so, without hedging or padding the claim.
