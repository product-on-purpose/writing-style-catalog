---
diff_pair_id: voice-coach-vs-friendly-mentor-a-hard-year-in-review
...
# Diff Pair: Voice swap - `coach` vs `friendly-mentor`

**Topic:** A personal year-end reckoning with a difficult year
**Axis varied:** voice
**A:** `coach` - A facilitative voice that builds capacity through questions and reflection, acknowledges complexity before offering direction, and creates space without abandoning the reader.
