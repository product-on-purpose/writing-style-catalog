...
**Status:** OPEN - 7 of 9 P0 rows decided 2026-06-09 (A6, B1, C1, C2, C3, F2, F3). A1 (taxonomy cuts) deferred to independent external review; D1 (anchor topics) deferred pending A1 and example review. P1 and P2 rows still `_pending_`.
...
|---|---|---|---|---|
| A1 | Accept the v2 taxonomy cuts | Accept as-is | P0 | **Deferred - independent external review (Fable)** (2026-06-09) |
...
- **2 P0 rows are deliberately still open.** A1 - taxonomy cuts is out for independent external review (`_LOCAL/2026-06-09_a1-taxonomy-evaluation_by-fable.md`); until it resolves, ADR 0010 stays Proposed and the tighten-to-required step (F2 phase 3) does not run. D1 - anchor topics is deferred pending A1 and example review, and pending a decision on whether to expand or randomize the topic set.
