...
**invitation**: An announcement tells an audience that something is true or changing and asks nothing of them beyond understanding it. An invitation asks for a response: attendance, an RSVP, a decision to come. If the reader can do nothing and still have received the message correctly, it is an announcement.
