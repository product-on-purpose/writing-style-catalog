...
| --- | --- | --- | --- |
| `taxonomy/` | The catalog. 118 `ENTRY.md` files across `voices/`, `tones/`, `styles/`, `formats/` (15 machine-verified each for Voice/Tone/Style, plus 1 draft Voice; Format has 52 machine-verified + 20 draft). | Source of truth | Catalog author |
