...
- **15 format templates** giving the canonical structure for each format (plus 33 draft candidate formats under review from the Stream-B breadth program).
...
- 60 stable taxonomy entries (15 each across Voice, Tone, Style, Format), plus 33 draft format candidates under review (Stream-B breadth, batches 1-6)
