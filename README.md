...
- **480 worked examples** across eight anchor topics (async standups, morning routine, a Postgres-vs-DynamoDB decision, a roadmap deprioritization, onboarding a new hire, thanking a mentor, keeping a day of rest, and a retirement send-off), so you can see each entry rendered on real content.
...
- 480 worked examples across eight anchor topics, plus 66 diff-pairs and 14 horizontal-slice recipes
