...
- **195 worked examples** across three anchor topics (async standups, morning routine, a Postgres-vs-DynamoDB decision), so you can see each entry rendered on real content.
- **22 diff-pairs** that hold a topic constant and vary one axis, so the effect of a single choice is visible side by side.
- **5 horizontal-slice recipes** - named, ready-to-use four-axis combinations for common writing tasks.
...
- 195 worked examples across three anchor topics, plus 22 diff-pairs and 5 horizontal-slice recipes
