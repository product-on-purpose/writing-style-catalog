...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.8.0-blue.svg?style=flat-square" alt="Version">
...
> [!WARNING]
> **Early and experimental (v0.8.0).** This project is in active early development. The catalog, schema, skill interface, and docs may change without notice; entries are still under review; and the Composer and SDK surfaces are deliberately deferred indefinitely (see [ROADMAP.md](ROADMAP.md)). Use it, learn from it, and expect rough edges. Not recommended for production reliance.
